...
import { Building2, Home, MapPin, ChevronRight } from 'lucide-react-native';
          ...
          residences.map((res: any) => {
            ...
            return (
              <View key={res.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                ...
                >
                  <View className="w-10 h-10 rounded-xl items-center justify-center" style={{ backgroundColor: '#f5f3ff' }}>
                    <Building2 size={18} color="#7c3aed" />
                  </View>
                  <View className="flex-1">
                    ...
                    {res.adresse && (
                      <View className="flex-row items-center gap-1 mt-0.5">
                        ...
                        <Text className="text-xs text-gray-400">{res.adresse}</Text>
                      </View>
                    )}
                  </View>
                ...
                {isOpen && apps.length > 0 && (
                  <View className="border-t border-gray-100">
                    {apps.map((app: any, i: number) => {
                      const s = STATUS[app.statut] ?? STATUS.disponible;
                      return (
                        <View
                          key={app.id}
                        ...
                        >
                          ...
                          <View className="flex-1">
                            ...
                            <Text className="text-xs text-gray-400 mt-0.5">
                              {app.surface_m2 ? `${app.surface_m2} m²` : ''}
